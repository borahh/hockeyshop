...
${expression ? 'Expression: "' + expression + '"\n\n' : ''}`,
        ...
        var hasChanged = (value, oldValue) =>
          value !== oldValue && (value === value || oldValue === oldValue); // node_modules/@vue/reactivity/dist/reactivity.esm-bundler.js
        ...
        function isListeningForASpecificKeyThatHasntBeenPressed(e, modifiers) {
          let keyModifiers = modifiers.filter((i) => {
            return !['window', 'document', 'prevent', 'stop', 'once'].includes(
              i,
            );
          });
        ...
        function getVariationEl(variation, data) {
          ...
          variation.list.forEach(function (item) {
            var el = document.querySelector(
              'ul[data-attribute_name="'.concat(item, '"]'),
            );
    ...
    'calculator/ui.js': [
          ...
          onToggleOpen: function onToggleOpen() {
            if (this.open) {
              this.$el.style.maxHeight =
                ...
                (0, _getAbsoluteHeight.getAbsoluteHeight)(
                  '.calculator__wraper__content__nav',
                ) +
                'px';
            } else {
      ...
      { '../helpers/getAbsoluteHeight': 'helpers/getAbsoluteHeight.js' },
    ],
    'calculator/types/BauerIcehockeySkates.js': [
      function (require, module, exports) {
        'use strict';
        ...
        function BauerIcehockeySkates() {
          return _objectSpread(
            _objectSpread({}, _ui.calculatorUI),
            {},
            {
              maxStep: 3,
              units: [
              ...
              reccomendLength: function reccomendLength() {
                ...
                var fit = document.querySelector(
                  'input[name = "__fit"]:checked',
                ).value;
                ...
                var AvailableVariationsLoader = JSON.parse(
                  document
                ...
                if (
                  ...
                  var selectFit = (0, _getVariationEl.getVariationEl)(
                    AvailableVariationsLoader.length,
                    this.dataObtained.fit,
                  );
                  var selectScale = (0, _getVariationEl.getVariationEl)(
      ...
      {
        '../../helpers/getVariationEl': 'helpers/getVariationEl.js',
        '../ui': 'calculator/ui.js',
      },
    ],
    'calculator/types/CCMSkates.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ElbowPads/CCMBase.js': [
      function (require, module, exports) {
        'use strict';
        ...
        var ElbowPads = _objectSpread(
          _objectSpread(
            _objectSpread({}, _ui.calculatorUI),
            _unitConverter.cmToInch,
          ),
          {},
          {
            maxStep: 1,
            ...
            handleFinal: function handleFinal() {
              ...
              if (
                ...
                var selectSize = (0, _getVariationEl.getVariationEl)(
      ...
      },
      {
        '../../../helpers/getVariationEl': 'helpers/getVariationEl.js',
        '../../ui': 'calculator/ui.js',
        '../../unitConverter': 'calculator/unitConverter.js',
      },
    ],
    'calculator/types/ElbowPads/CCMElbowPadsJR.js': [
      function (require, module, exports) {
        'use strict';
        ...
        function CCMElbowPadsJR() {
          return _objectSpread(
            _objectSpread({}, _CCMBase.ElbowPads),
            {},
            {
      ...
      { './CCMBase': 'calculator/types/ElbowPads/CCMBase.js' },
    ],
    'calculator/types/ElbowPads/CCMElbowPadsSR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ElbowPads/CCMElbowPadsYT.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ElbowPads/BauerBase.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ElbowPads/BauerElbowPadsINT.js': [
      function (require, module, exports) {
        'use strict';
        ...
        function BauerElbowPadsINT() {
          return _objectSpread(
            _objectSpread({}, _BauerBase.ElbowPads),
            {},
            {
              input: {
                length: 24,
      ...
      { './BauerBase': 'calculator/types/ElbowPads/BauerBase.js' },
    ],
    'calculator/types/ElbowPads/BauerElbowPadsJR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ElbowPads/BauerElbowPadsSR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ElbowPads/index.js': [
      function (require, module, exports) {
        'use strict';
        ...
        Object.keys(_BauerElbowPadsINT).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerElbowPadsINT[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
      ...
      {
        './CCMElbowPadsJR': 'calculator/types/ElbowPads/CCMElbowPadsJR.js',
        './CCMElbowPadsSR': 'calculator/types/ElbowPads/CCMElbowPadsSR.js',
        './CCMElbowPadsYT': 'calculator/types/ElbowPads/CCMElbowPadsYT.js',
        './BauerElbowPadsINT':
          'calculator/types/ElbowPads/BauerElbowPadsINT.js',
        './BauerElbowPadsJR': 'calculator/types/ElbowPads/BauerElbowPadsJR.js',
        './BauerElbowPadsSR': 'calculator/types/ElbowPads/BauerElbowPadsSR.js',
      },
    ],
    'calculator/types/ElbowPads/BauerElbowPadsYT.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/Gloves/CCMBase.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/Gloves/CCMGlovesJR.js': [
      function (require, module, exports) {
        'use strict';
      ...
      { './CCMBase': 'calculator/types/Gloves/CCMBase.js' },
    ],
    'calculator/types/Gloves/CCMGlovesSR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/Gloves/CCMGlovesYT.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/Gloves/BauerBase.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/Gloves/BauerGlovesYT.js': [
      function (require, module, exports) {
        'use strict';
        ...
        function BauerGlovesYT() {
          return _objectSpread(
            _objectSpread({}, _BauerBase.Gloves),
            {},
            {
              input: {
                length: 10.5,
      ...
      { './BauerBase': 'calculator/types/Gloves/BauerBase.js' },
    ],
    'calculator/types/Gloves/BauerGlovesJR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/Gloves/BauerGlovesINT.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/Gloves/BauerGlovesSR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/Gloves/index.js': [
      function (require, module, exports) {
        'use strict';
      ...
      {
        './CCMGlovesJR': 'calculator/types/Gloves/CCMGlovesJR.js',
        './CCMGlovesSR': 'calculator/types/Gloves/CCMGlovesSR.js',
        './CCMGlovesYT': 'calculator/types/Gloves/CCMGlovesYT.js',
        './BauerGlovesYT': 'calculator/types/Gloves/BauerGlovesYT.js',
        './BauerGlovesJR': 'calculator/types/Gloves/BauerGlovesJR.js',
        './BauerGlovesINT': 'calculator/types/Gloves/BauerGlovesINT.js',
        './BauerGlovesSR': 'calculator/types/Gloves/BauerGlovesSR.js',
      },
    ],
    'calculator/types/PlayerPants/CCMBase.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/PlayerPants/CCMPlayerPantsJR.js': [
      function (require, module, exports) {
        'use strict';
        ...
        function CCMPlayerPantsJR() {
          return _objectSpread(
            _objectSpread({}, _CCMBase.PlayerPants),
            {},
            {
      ...
      { './CCMBase': 'calculator/types/PlayerPants/CCMBase.js' },
    ],
    'calculator/types/PlayerPants/CCMPlayerPantsSR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/PlayerPants/CCMPlayerPantsYT.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/PlayerPants/CCMPlayerPantsWOMEN.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/PlayerPants/BauerBase.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/PlayerPants/BauerPlayerPantsYT.js': [
      function (require, module, exports) {
        'use strict';
        ...
        function BauerPlayerPantsYT() {
          return _objectSpread(
            _objectSpread({}, _BauerBase.PlayerPants),
            {},
            {
              input: {
                waist: 48,
      ...
      { './BauerBase': 'calculator/types/PlayerPants/BauerBase.js' },
    ],
    'calculator/types/PlayerPants/BauerPlayerPantsJR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/PlayerPants/BauerPlayerPantsINT.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/PlayerPants/BauerPlayerPantsSR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/PlayerPants/BauerPlayerPantsWOMEN.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/PlayerPants/index.js': [
      function (require, module, exports) {
        'use strict';
        ...
        Object.keys(_CCMPlayerPantsWOMEN).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _CCMPlayerPantsWOMEN[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerPlayerPantsYT).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerPlayerPantsYT[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerPlayerPantsJR).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerPlayerPantsJR[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerPlayerPantsINT).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerPlayerPantsINT[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerPlayerPantsSR).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerPlayerPantsSR[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerPlayerPantsWOMEN).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerPlayerPantsWOMEN[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
    ...
    'calculator/types/ShinGuards/CCMBase.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShinGuards/CCMShinGuardsJR.js': [
      function (require, module, exports) {
        'use strict';
        ...
        function CCMShinGuardsJR() {
          return _objectSpread(
            _objectSpread({}, _CCMBase.ShinGuards),
            {},
            {
      ...
      { './CCMBase': 'calculator/types/ShinGuards/CCMBase.js' },
    ],
    'calculator/types/ShinGuards/CCMShinGuardsSR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShinGuards/CCMShinGuardsYT.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShinGuards/BauerBase.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShinGuards/BauerShinGuardsYT.js': [
      function (require, module, exports) {
        'use strict';
        ...
        function BauerShinGuardsYT() {
          return _objectSpread(
            _objectSpread({}, _BauerBase.ShinGuards),
            {},
            {
              input: {
                length: 25.5,
      ...
      { './BauerBase': 'calculator/types/ShinGuards/BauerBase.js' },
    ],
    'calculator/types/ShinGuards/BauerShinGuardsJR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShinGuards/BauerShinGuardsINT.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShinGuards/BauerShinGuardsSR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShinGuards/index.js': [
      function (require, module, exports) {
        'use strict';
        ...
        Object.keys(_BauerShinGuardsYT).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerShinGuardsYT[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerShinGuardsJR).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerShinGuardsJR[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerShinGuardsINT).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerShinGuardsINT[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerShinGuardsSR).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerShinGuardsSR[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
      ...
      {
        './CCMShinGuardsJR': 'calculator/types/ShinGuards/CCMShinGuardsJR.js',
        './CCMShinGuardsSR': 'calculator/types/ShinGuards/CCMShinGuardsSR.js',
        './CCMShinGuardsYT': 'calculator/types/ShinGuards/CCMShinGuardsYT.js',
        './BauerShinGuardsYT':
          'calculator/types/ShinGuards/BauerShinGuardsYT.js',
        './BauerShinGuardsJR':
          'calculator/types/ShinGuards/BauerShinGuardsJR.js',
    ...
    'calculator/types/ShoulderPads/CCMBase.js': [
      function (require, module, exports) {
        'use strict';
        ...
        var ShoulderPads = _objectSpread(
          _objectSpread(
            _objectSpread({}, _ui.calculatorUI),
            _unitConverter.cmToInch,
          ),
    ...
    'calculator/types/ShoulderPads/CCMShoulderPadsJR.js': [
      function (require, module, exports) {
        'use strict';
        ...
        function CCMShoulderPadsJR() {
          return _objectSpread(
            _objectSpread({}, _CCMBase.ShoulderPads),
            {},
            {
      ...
      { './CCMBase': 'calculator/types/ShoulderPads/CCMBase.js' },
    ],
    'calculator/types/ShoulderPads/CCMShoulderPadsSR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShoulderPads/CCMShoulderPadsWOMEN.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShoulderPads/CCMShoulderPadsYT.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShoulderPads/BauerBase.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShoulderPads/BauerShoulderPadsYT.js': [
      function (require, module, exports) {
        'use strict';
        ...
        function BauerShoulderPadsYT() {
          return _objectSpread(
            _objectSpread({}, _BauerBase.ShoulderPads),
            {},
            {
              input: {
                chest: 51,
      ...
      { './BauerBase': 'calculator/types/ShoulderPads/BauerBase.js' },
    ],
    'calculator/types/ShoulderPads/BauerShoulderPadsJR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShoulderPads/BauerShoulderPadsINT.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShoulderPads/BauerShoulderPadsSR.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShoulderPads/BauerShoulderPadsWOMEN.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'calculator/types/ShoulderPads/index.js': [
      function (require, module, exports) {
        'use strict';
        ...
        Object.keys(_CCMShoulderPadsJR).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _CCMShoulderPadsJR[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_CCMShoulderPadsSR).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _CCMShoulderPadsSR[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_CCMShoulderPadsWOMEN).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _CCMShoulderPadsWOMEN[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_CCMShoulderPadsYT).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _CCMShoulderPadsYT[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerShoulderPadsYT).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerShoulderPadsYT[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerShoulderPadsJR).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerShoulderPadsJR[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerShoulderPadsINT).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerShoulderPadsINT[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerShoulderPadsSR).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerShoulderPadsSR[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
        ...
        Object.keys(_BauerShoulderPadsWOMEN).forEach(function (key) {
          if (key === 'default' || key === '__esModule') return;
          if (key in exports && exports[key] === _BauerShoulderPadsWOMEN[key])
            return;
          Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
    ...
    'calculator.js': [
      function (require, module, exports) {
        ...
        if (_alpinejs.default) {
          _alpinejs.default.data(
            'BauerIcehockeySkates',
            _BauerIcehockeySkates.BauerIcehockeySkates,
          );
          ...
          _alpinejs.default.data(
            'BauerShoulderPadsJR',
            _ShoulderPads.BauerShoulderPadsJR,
          );

          _alpinejs.default.data(
            'BauerShoulderPadsSR',
            _ShoulderPads.BauerShoulderPadsSR,
          );

          _alpinejs.default.data(
            'BauerShoulderPadsYT',
            _ShoulderPads.BauerShoulderPadsYT,
          );

          _alpinejs.default.data(
            'BauerShoulderPadsINT',
            _ShoulderPads.BauerShoulderPadsINT,
          );

          _alpinejs.default.data(
            'BauerShoulderPadsWOMEN',
            _ShoulderPads.BauerShoulderPadsWOMEN,
          );

          _alpinejs.default.data(
            'CCMShoulderPadsJR',
            _ShoulderPads.CCMShoulderPadsJR,
          );

          _alpinejs.default.data(
            'CCMShoulderPadsYT',
            _ShoulderPads.CCMShoulderPadsYT,
          );

          _alpinejs.default.data(
            'CCMShoulderPadsSR',
            _ShoulderPads.CCMShoulderPadsSR,
          );

          _alpinejs.default.data(
            'CCMShoulderPadsWOMEN',
            _ShoulderPads.CCMShoulderPadsWOMEN,
          );

          _alpinejs.default.data(
            'BauerElbowPadsSR',
            _ElbowPads.BauerElbowPadsSR,
          );

          _alpinejs.default.data(
            'BauerElbowPadsJR',
            _ElbowPads.BauerElbowPadsJR,
          );

          _alpinejs.default.data(
            'BauerElbowPadsYT',
            _BauerElbowPadsYT.BauerElbowPadsYT,
          );

          _alpinejs.default.data(
            'BauerElbowPadsINT',
            _ElbowPads.BauerElbowPadsINT,
          );
          ...
          _alpinejs.default.data(
            'BauerShinGuardsJR',
            _ShinGuards.BauerShinGuardsJR,
          );

          _alpinejs.default.data(
            'BauerShinGuardsSR',
            _ShinGuards.BauerShinGuardsSR,
          );

          _alpinejs.default.data(
            'BauerShinGuardsYT',
            _ShinGuards.BauerShinGuardsYT,
          );

          _alpinejs.default.data(
            'BauerShinGuardsINT',
            _ShinGuards.BauerShinGuardsINT,
          );

          _alpinejs.default.data(
            'CCMShinGuardsJR',
            _ShinGuards.CCMShinGuardsJR,
          );

          _alpinejs.default.data(
            'CCMShinGuardsSR',
            _ShinGuards.CCMShinGuardsSR,
          );

          _alpinejs.default.data(
            'CCMShinGuardsYT',
            _ShinGuards.CCMShinGuardsYT,
          );

          _alpinejs.default.data(
            'BauerPlayerPantsJR',
            _PlayerPants.BauerPlayerPantsJR,
          );

          _alpinejs.default.data(
            'BauerPlayerPantsSR',
            _PlayerPants.BauerPlayerPantsSR,
          );

          _alpinejs.default.data(
            'BauerPlayerPantsYT',
            _PlayerPants.BauerPlayerPantsYT,
          );

          _alpinejs.default.data(
            'BauerPlayerPantsINT',
            _PlayerPants.BauerPlayerPantsINT,
          );

          _alpinejs.default.data(
            'BauerPlayerPantsWOMEN',
            _PlayerPants.BauerPlayerPantsWOMEN,
          );

          _alpinejs.default.data(
            'CCMPlayerPantsJR',
            _PlayerPants.CCMPlayerPantsJR,
          );

          _alpinejs.default.data(
            'CCMPlayerPantsSR',
            _PlayerPants.CCMPlayerPantsSR,
          );

          _alpinejs.default.data(
            'CCMPlayerPantsWOMEN',
            _PlayerPants.CCMPlayerPantsWOMEN,
          );

          _alpinejs.default.data(
            'CCMPlayerPantsYT',
            _PlayerPants.CCMPlayerPantsYT,
          );
      ...
      },
      {
        ...
        './calculator/types/BauerIcehockeySkates':
          'calculator/types/BauerIcehockeySkates.js',
        './calculator/types/CCMSkates': 'calculator/types/CCMSkates.js',
        './calculator/types/ElbowPads': 'calculator/types/ElbowPads/index.js',
        './calculator/types/ElbowPads/BauerElbowPadsYT':
          'calculator/types/ElbowPads/BauerElbowPadsYT.js',
        './calculator/types/Gloves': 'calculator/types/Gloves/index.js',
        './calculator/types/PlayerPants':
          'calculator/types/PlayerPants/index.js',
        './calculator/types/ShinGuards': 'calculator/types/ShinGuards/index.js',
        './calculator/types/ShoulderPads':
          'calculator/types/ShoulderPads/index.js',
      },
    ],
    'index.js': [
