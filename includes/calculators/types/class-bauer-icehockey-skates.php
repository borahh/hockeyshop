...
class BauerIcehockeySkates extends BorahhCalculatorBase {
    ...
    protected function heightOptions($options) {
        ...
        <div class="calculator__wraper__content__form__tab--height__option">
            ...
            <img class="calculator__wraper__content__form__tab--height__option__img_active peer-checked:opacity-100" src="<?php echo BORAHH_HOCKEYSHOP_IMG_URL . 'foot-height-' . $option . '-active.webp'; ?>" alt="" />
