...
class BauerIcehockeySkates extends BorahhCalculatorBase {
    ...
    protected function widthOptions($options) {
        ...
        <div>
            ...
            <img class="peer-checked:hidden" src="<?php echo BORAHH_HOCKEYSHOP_IMG_URL . 'foot-width-' . $option . '-inactive.webp'; ?>" alt="" />
            <img class="hidden peer-checked:block" src="<?php echo BORAHH_HOCKEYSHOP_IMG_URL . 'foot-width-' . $option . '-active.webp'; ?>" alt="" />
