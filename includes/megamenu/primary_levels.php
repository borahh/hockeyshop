    ...
    <div class=" flex justify-between lg:block items-center ">
     <div class="flex justify-between items-center gap-2 flex-grow p-3 pr-0 lg:pr-5 2xl:p-8 text-white lg:grid lg:grid-cols-3 lg:justify-items-center">
                ...
                <div
                    ...
                    <input type="text" name="search" id="search"
                        ...
                        placeholder="search">
                        <svg class ="h-6 w-6 fill-current stroke-0" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button class='hidden text-white flex flex-col justify-center  lg:hidden ' id='close_all_opened'>
                <svg class = 'h-6 w-6' viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button
                ...
                <svg class = 'h-6 w-6' viewBox="0 0 27 22" fill="none" xmlns="http://www.w3.org/2000/svg">
     ...
     <div class="menu item  overflow-y-scroll lg:overflow-visible overflow-x-hidden  flex flex-col lg:bg-[#1d1d1d] ">
               ...
               <div class="hbdv_megamenu relative  p-5 lg:static  flex-grow lg:flex  lg:p-0 lg:justify-center lg:items-center lg:w-full">
                ...
                ?>
                 <div class="absolute  bottom-0 left-0 w-full bg-gradient-to-t from-white via-white to-transparent  font-bold grid grid-cols-2 justify-center lg:hidden p-4 font-social-gothic ">
                         <a href="#" class = 'flex flex-col items-center'>
                             <img src="<?php echo BORAHH_HOCKEYSHOP_IMG_URL . 'currency.png'; ?>" alt="icon" class='w-8'>
                              Vault
                         </a>
                         <a href="#" class = 'flex flex-col items-center'>
                              <img src="<?php echo BORAHH_HOCKEYSHOP_IMG_URL . 'user.png'; ?>" alt="icon" class='w-8'>
                              My Account
                         </a>
                    </div>
            </div>
