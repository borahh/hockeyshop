...
function get_hockeyshop_menu_holder() {
                   ...
                   // Check rows exists.
                        if( have_rows('hbdv_menu_links', 'option') ):
                            ...
                            while( have_rows('hbdv_menu_links', 'option') ) : the_row();
								...
								?>
                                <a href="<?php echo $url; ?>"><?php _e($title, 'hockeyshop-theme'); ?></a>
    ...
    <div class="flex items-center justify-between lg:block">
     <div class="flex items-center justify-between flex-grow gap-2 p-3 pr-0 text-white lg:pr-5 2xl:py-8 lg:grid lg:grid-cols-3 lg:justify-items-center w-11/12 max-w-[1500px] mx-auto">
                <a href="https://hockeyshop.dk/" class="w-[90px] lg:w-[200px] xl:w-[230px] lg:order-2">
					<?php $site_logo =  get_field('hbdv_site_logo', 'option'); ?>
                ...
                <div class="flex items-center order-3 text-base font-bold text-white uppercase font-social-gothic">
                    ...
                    <span class = 'bg-[#ff0000] text-white aspect-square rounded-full absolute h-[19px] w-fit -top-[10px] -right-[5px] text-[12px] flex items-center justify-center'><?php echo WC()->cart->get_cart_contents_count() ?></span>
                    </div>

                        <span class="hidden lg:block "><?php _e("Kurv", "hockeyshop-theme"); ?></span>
                    </a>
               ...
               <div class="relative flex-grow p-5 hbdv_megamenu lg:static lg:flex lg:p-0 lg:justify-center lg:items-center lg:w-full">
                ...
                if( have_rows('hbdv_mega_primary_levels', 'option') ):  
                    ...
                    <div class="hbdv_megamenu__primary drop_down">
                        <a href="<?php echo $url; ?>" class="hbdv_megamenu__primary--btn btn" ><?php _e($title, 'hockeyshop-theme'); ?></a>
